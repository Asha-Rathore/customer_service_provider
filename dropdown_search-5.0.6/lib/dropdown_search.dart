...
class DropdownSearch<T> extends StatefulWidget {
  ...
  ///Hint Text
  final String? hintTextForMultipleSelection;
  ...
  DropdownSearch({
    ...
    this.hintTextForMultipleSelection = "",
              ...
              return ValueListenableBuilder<bool>(
                  ...
                  builder: (context, isFocused, w) {
                    return InputDecorator(
                      ...
                      isFocused: isFocused,
                      decoration: _manageDropdownDecoration(state),
                      child: getSelectedItems.isEmpty
                          ? Container()
                          : Text(widget.hintTextForMultipleSelection ?? "",
                              style: widget.textStyle),
                      // child: getSelectedItems.isEmpty ? Container() : Container(),
                      // _defaultSelectedItemWidget(),
                    );
                  });
            },
