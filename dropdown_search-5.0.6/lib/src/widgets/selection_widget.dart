...
class SelectionWidget<T> extends StatefulWidget {
  ...
  final TextStyle? buttonTextStyle, itemTextStyle;
      ...
      child: Align(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: Color(0xff8300C4),
            disabledForegroundColor: Color(0xff8300C4).withOpacity(0.38),
            disabledBackgroundColor: Color(0xff8300C4).withOpacity(0.12),
            shadowColor: Color(0xff8300C4),
          ),
          onPressed: onValidate,
          child: Text("OK", style: widget.buttonTextStyle,),
        ),
      ),
    );
