...
class IntlPhoneField extends StatefulWidget {
  ...
  final String? emptyNumberMessage;
    ...
    return TextFormField(
      ...
      decoration: widget.decoration.copyWith(
        ...
        widget.isSuffixIcon==true?
         InkWell(
          ...
          child: Icon(widget.suffixIcon,color: widget.suffixIconColor,)):null,
      ...
      validator: (value) {
        if(value==null|| value.isEmpty){
          return widget.emptyNumberMessage??"";
        }
    ...
    return Container(
      ...
      child: DecoratedBox(
        ...
        child: InkWell(
          ...
          onTap: 
          widget.showDialogue==true?
           widget.enabled ? _changeCountry : null:null,
        ),
      ),
    );
  }
