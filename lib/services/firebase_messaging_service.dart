...
import 'package:customer_service_provider_hybrid/services/connectivity_manager.dart';
...
class FirebaseMessagingService {
  ...
  void _showLocalNotification(
    ...
    if (notificationData != null) {
      ...
      print("NotificationType Id:${notificationData["type_id"]}");
      print("NotificationType Id:${StaticData.chatFriendId?.toString()}");
      ...
      if (notificationData["type"] ==
          ...
          notificationData["type_id"] == StaticData.chatFriendId?.toString()) {
